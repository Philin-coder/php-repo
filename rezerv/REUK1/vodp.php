    	...
    	<div class="container">
			...
			<form enctype='multipart/form-data'  action="" method="POST"   class="form-inline">
				...
				<div class="form-group mb-2 col-4">
					<input type="text" class="form-control"  name="nam"  placeholder="Введите название" requered>
				</div>
				<div class="form-group mb-2 col-4">
...
<label class="label">Выберитекартинку</label><br>
...
$query = mysqli_query($link,"INSERT INTO pizza(name,img,zena) VALUES ('".$name."','".$foto_name."', '".$zena."')") or die("Ошибкадобавлениябукетов");
