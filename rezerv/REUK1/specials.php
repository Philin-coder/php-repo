...
mysqli_query($link, "SET NAMES 'utf8'");
 $sql="SELECT * from pizza";
  $result1=mysqli_query($link,$sql) or die("Ошибка выборки услуг"); 
?>
...
?>  
    ...
    <div class="page-title-img">
        <img class="img-full" alt="page title img" src="assets/images/headers/15_pitstsa.jpg">
    ...
    <section>
    	<div class="container">
            <h1 class="bottom-line">Специальные предложения</h1>
            <p class="text-center"><em>Воспользуйтесь уникальными предложеними.</em></p>
            ...
            <div id="slider-specials" class="flexslider">
                <ul class="slides">
                    <li>
                    	<a href="#section-menu" class="scroll-to">
                            <article class="offer-alt">
                                <img alt="product" src="assets/images/slider2/e6b1abdc-44a4-4949-badb-a86800e5022c.jpg">
                                <div class="offer-detail">
                                    <h4 class="offer-heading">Грибная</h4>
                                    <em></em>
                                    <div class="price-huge clearfix">
                                        <div class="pull-left">
                                            <span class="price-currency">399</span>
                                        </div>
                                        <div class="pull-left">
                                            <span class="price-val-2">руб</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="offer-price-small">
                                    <span class="offer-price-val1"></span><span class="offer-price-val2">99</span>
                                </div>
                            </article>
                    	</a>
                    </li>
                    <li>
                    	<a href="#section-menu" class="scroll-to">
                            <article class="offer-alt">
                                <img alt="product" src="assets/images/slider2/IMG_4841-1024x683.jpg">
                                <div class="offer-detail">
                                    <h4 class="offer-heading">Четыре сезона</h4>
                                    <em></em>
                                    <div class="price-huge clearfix">
                                        <div class="pull-left">
                                            <span class="price-currency">549</span>
                                        </div>
                                        <div class="pull-left">
                                            <span class="price-val-2">руб</span>
                                        </div>
                    ...
                    <li>
                    	<a href="#section-menu" class="scroll-to">
                            <article class="offer-alt">
                                <img alt="product" src="assets/images/slider2/427.jpg">
                                <div class="offer-detail">
                                    <h4 class="offer-heading">Кудро</h4>
                                    <em></em>
                                    <div class="price-huge clearfix">
                                        <div class="pull-left">
                                            <span class="price-currency">699</span>
                                        </div>
                                        <div class="pull-left">
                                            <span class="price-val-2">руб</span>
                                        </div>
                    ...
                    <li>
                    	<a href="#section-menu" class="scroll-to">
                            <article class="offer-alt">
                                <img alt="product" src="assets/images/slider2/s1200.jpg">
                                <div class="offer-detail">
                                    <h4 class="offer-heading">Монтанара</h4>
                                    <em></em>
                                    <div class="price-huge clearfix">
                                        <div class="pull-left">
                                            <span class="price-currency">799</span>
                                        </div>
                                        <div class="pull-left">
                                            <span class="price-val-2">руб.</span>
                                        </div>
                    ...
                    <li>
                    	<a href="#section-menu" class="scroll-to">
                            <article class="offer-alt">
                                <img alt="product" src="assets/images/slider2/iC3LFWMIL.jpg">
                                <div class="offer-detail">
                                    <h4 class="offer-heading">Американо</h4>
                                    <em></em>
                                    <div class="price-huge clearfix">
                                        <div class="pull-left">
                                            <span class="price-currency">349</span>                                        </div>
                                        <div class="pull-left">
                                            <span class="price-val-2">руб.</span>
                                        </div>
                                    </div>
            ...
            <div id="slider-specials-thumbs" class="flexslider flexslider-thumbs">
                <ul class="slides">
                    <li>
                        <img alt="product thumbnail" src="assets/images/slider2/iBS2SAINQ.jpg">
                    </li>
                    <li>
                        <img alt="product thumbnail" src="assets/images/slider2/i1HYAOB62.jpg">
                    </li>
                    <li>
                        <img alt="product thumbnail" src="assets/images/slider2/iIKFOEPRL.jpg">
                    </li>
                    <li>
                        <img alt="product thumbnail" src="assets/images/slider2/s1уцк200.jpg">
                    </li>
                    <li>
                        <img alt="product thumbnail" src="assets/images/slider2/iC3LFтиWMIL.jpg">
                    </li>
                </ul>
...
{?>
	   <div class="content__text mt-2">
        <div class="page-image page-image--right"><img src="<?echo $row["img"];?>" alt="" class="img-responsive" width = "180px" height = "180px">
        </div>
        ...
        <p><?echo $row["zena"];?> </p>
            ...
            <div class="row">
            	<div class="col-md-4">
                	<article class="post-preview">
                    	<a href="assets/images/blog/post4.jpg" data-lightbox="blog-post4"><img class="post-img" alt="blog post" src="assets/images/blog/post4.jpg"></a>
                        <div class="post-content">
            	...
            	<div class="col-md-4">
                	<article class="post-preview">
                    	<a href="assets/images/blog/post5.jpg" data-lightbox="blog-post5"><img class="post-img" alt="blog post" src="assets/images/blog/post5.jpg"></a>
                        <div class="post-content">
                            <h2 class="post-heading">Blogs Posts for Restaurant</h2>
                            <p class="post-meta">
                            	by <a href="#">Chef</a>
            	...
            	<div class="col-md-4">
                	<article class="post-preview">
                    	<a href="assets/images/blog/post6.jpg" data-lightbox="blog-post6"><img class="post-img" alt="blog post" src="assets/images/blog/post6.jpg"></a>
                        <div class="post-content">
                            <h2 class="post-heading">Baking Great Meals</h2>
                            <p class="post-meta">
                            	by <a href="#">Chef</a>
