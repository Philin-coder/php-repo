...
?>  
    ...
    <section>
    	<div class="container">
        	<h1 class="bottom-line">Форма заказа</h1>
            <p class="text-center"><em>Только у нас можно выгодно заказать наши изделия по средам акция,купи две пиццы и третью получи в подарок. </em></p>
            <h3 class="text-center text-uppercase">Закажи прямо сейчас</h3>
            <form class="text-center" method="POST">
				...
				<div class="form-group mb-2 col-4">
					<select name='id_pizza'><br><br>   
					<?
					$sql = mysqli_query($link,"select * from pizza");
					while ($row = mysqli_fetch_array($sql)) {
						
					echo'<option value="'.$row['id_pizza'].'">'.$row['name'].'</option>';}	
            	...
            	<div class="row">
                    ...
                    <div class="col-sm-6">
					<?
                    	$string_a=htmlentities($_POST['kol_vo']);
						$string_b=htmlentities($_POST['zena']);
							$a = (int)$string_a;
	                        $b = (int)$string_b;
	                         $c = $a*$b;
                      ?>  	
					  <div class="col-xs-5">
            					<input type="text" name="kol_vo" placeholder="Кол.во" value="<?php echo $a;?>" >
                        	</div>
                            <div class="col-xs-5">
                            <input type="text" name="zena" placeholder="Цена" value="<?php echo $b;?>" >	
                            </div>
							<br>
                            <div class="col-xs-2">
							...
							<div class="col-xs-5">
            					...
            					<input type="text" name="summa_p" placeholder="Сумма" value="<?php echo $c;?>" >
                            </div>
							<div class="col-xs-5">
				...
				<input type="reset" class="button-yellow button-long with-right-arrow form-submit-trigger" value="Сбросить"><br><br>
				<input type="submit" class="button-yellow button-long with-right-arrow form-submit-trigger" value=" Заказать">
				</div>
				</div>
            </form>
	...
	if (!empty($_POST)) 
{
	...
	$data=$_POST['data'];
	$zena=$_POST['zena'];
	$summa_p=$_POST['summa_p'];
	$kol_vo=$_POST['kol_vo'];
	$fio=$_POST['fio'];
	$sql =mysqli_query ($link,"insert into zakaz (id_pizza,adres,tel,data,summa_p,kol_vo,fio) values ('$id_pizza','$adres','$tel','$data','$summa_p','$kol_vo','$fio')");
