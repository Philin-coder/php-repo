...
?>  
    ...
    <section>
        <div class="container">
            <h1 class="bottom-line">О нас</h1>
            <p class="text-center"><em></em></p>
            <div class="row">
                <div class="col-md-6">
                    <h2>История</h2>
                    <p>Приглашаем Вас посетить нашу пиццерию "PIZZA PLAZA"
У нас Вы всегда можете вкусно поесть, выпить чашечку ароматного кофе, отметить любое мероприятие, ну или просто провести время в хорошей компании. 
Вы по достоинству оцените уют и стиль, доброжелательную обстановку и 
замечательные изделия, которые помогут Вам отдохнуть и расслабиться. 
</p>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="worker">
                            	<div class="worker-head">
                                    ...
                                    <div class="worker-label">
                                        <h4>Алексей Иванович</h4>
                                        <em>Главный начальник</em>
                                    </div>
                            	</div><!-- .worker-head -->
                                <p class="worker-note">
                        ...
                        <div class="col-sm-6">
                            <div class="worker">
                            	<div class="worker-head">
                                    ...
                                    <div class="worker-label">
                                        <h4>Максим Владимирович</h4>
                                        <em>Шеф-повар пасты</em>
                                    </div>
                            	</div><!-- .worker-head -->
                                <p class="worker-note">
