...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 06 2022 г., 12:09
...
--
ALTER TABLE `disc`
  MODIFY `id_disc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT для таблицы `gruppa`
--
ALTER TABLE `gruppa`
  MODIFY `id_grupp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
