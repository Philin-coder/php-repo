...
public function get_oc_product()
    ...
    {
   $this->db->select('oc_product.model, 
   oc_product.sku,
    oc_product.upc,
     oc_product.ean,
     oc_product.ean, 
     ...
     oc_product.shipping,
     oc_product.price,oc_product.points, 
    ...
    $this->db->join('oc_product_image','oc_product_image.product_id=oc_product.product_id');
    $sql=$this->db->get();
...
public function oc_product_model_get_xml(){
    $this->db->select('oc_product.model, 
   oc_product.sku,
    oc_product.upc,
     oc_product.ean,
