    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-md-4 responsive-column">
                	<h2 class="footer-heading">Часы работы</h2>
                    <div class="opening-hours-wrapper">
                        <div class="row">
                            <div class="col-xs-6">
                                <em>Понедельник-Пятница</em>
                            </div>
                    ...
                    <h2 class="footer-heading">Наш адрес</h2>
                    <address>
                    	Главный Офис Пиццерии<br>
                        Большая Садовая ул., 107, Ростов-на-Дону<br>
            	...
            	<div class="col-md-4 text-center responsive-column">
                	...
                	<p class="logo-footer-text">PIZZA PLAZA</p>
                    <p class="logo-footer-detail"></p>
                    <a  href="delivery.php" class="scroll-to button-yellow button-heavy">СДЕЛАЙТЕ ЗАКАЗ ПРЯМО СЕЙЧАС!</a>
                </div><!-- .col-md-4 -->
            	<div class="col-md-4 responsive-column">
                    <h2 class="footer-heading text-uppercase">Подписаться сейчас</h2>
                    <div class="margin-10"></div>
                    <p>
                    	<em>Подпишитесь на наши обновления
и получайте регулярные предложения.</em>
                    </p>
                    <form id="form-newsletter" class="form-subscribe" action="assets/php/save_rss.php" method="post" data-email-not-set-msg="Email must be set." data-success-msg="Email added.">
                        ...
                        <div class="text-right">
                        	<input class="button-yellow button-heavy" type="submit" value="Подписаться">
                        </div>
                    </form>
                </div><!-- .col-md-4 -->
            </div><!-- .row -->
