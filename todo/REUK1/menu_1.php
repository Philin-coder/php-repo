...
?>  
    ...
    <div class="page-title-img">
        <img class="img-full" alt="page title img" src="assets/images/headers/nastol.com.ua-64313.jpg">
            	...
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/i4GV2SFUF.jpg">
                        </div>
                        <h3 class="product-title">Вегатерианская<br>400 руб</h3>
                        <p class="product-info"></p>
                       <!-- <a href="#" class="cart-trigger button-clean button-text-small">Оформить заказ сейчас</a>-->
                    </div><!-- .product-preview -->
        		</div><!-- .col-md-4 -->
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/item_2864632_1.jpg">
                        </div>
                        <h3 class="product-title">Грибная<br> 450 руб. </h3>
                        <p class="product-info"></p>
            	...
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/iB6168IYL.jpg">
                        </div>
                        <h3 class="product-title">Пепперони<br>500 руб.</h3>
                        <p class="product-info"></p>
            	...
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/iF1D19SRY.jpg">
                        </div>
                        <h3 class="product-title">Маргарита<br>550 руб.</h3>
                        <p class="product-info"></p>
            	...
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/DSC_1697-1024x683.jpg">
                        </div>
                        <h3 class="product-title">Четыре сезона<br>700 руб.</h3>
                        <p class="product-info"></p>
            	...
            	<div class="col-md-4">
                    <div class="product-preview">
                        <div class="product-photo">
                            ...
                            <img alt="product" src="assets/images/products/i2FRQ7X4C.jpg">
                        </div>
                        <h3 class="product-title">Карбонара<br>600 руб.</h3>
                        <p class="product-info"></p>
