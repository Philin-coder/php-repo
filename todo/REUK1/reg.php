...
?>  
    ...
    <div class="container">
    <form action="autoriz.php" class="row mt-5" method="POST">
       <div class="col-lg-6 offset-lg-3 bg-light pl-4 pt-3 pr-4 pb-3 mb-3">
            <div class="form-group">
                
            </div>
            <div class="form-group border-bottom mb-3">
                <h4 class="">Авторизация</h4>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="parol" placeholder="Ваш пароль">
            </div>
			
            <div class="form-group">
			
                <input type="submit" class="btn btn-success float-right" value="Войти"></a>
            </div>
        </div>
    </form>
</div>
...
/*  $login=$POST['login'];
 $parol=$POST['parol']; */
if(($POST['login']==$login_polzov ) && ($POST['parol']==$parol_polzov ) )
 {
  include "index.php";
