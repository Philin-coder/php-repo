...
?>   
    <a href="vod_piz.php" class="text-uppercase">Вход</a>     
    <section>
        <div class="container">
            <div id="product-slider" class="owl-pagination-dash owl-navigation-box">
                <div class="offer">
                    <img alt="product" src="assets/images/slider/iIPRTF8PJ.jpg">
                ...
                <div class="offer">
                    <img alt="product" src="assets/images/slider/pizza2-1024x682.jpg">
               ...
               <div class="offer">
                    <img alt="product" src="assets/images/slider/iOYKQVB1P.jpg">
            ...
            <div class="row">
                <div class="col-md-6">
                	<a href="#">
                        <article class="banner">
                            <img alt="banner" src="assets/images/banners/iUUB7KANY.jpg">
                ...
                <div class="col-md-6">
                	<a href="#">
                        <article class="banner">
                            <img alt="banner" src="assets/images/banners/i9BTBNE8M.jpg">
                            <div class="banner-over">
                                <div class="centered-columns">
                    ...
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Пицца</h3>
								Пи́цца итальянское национальное блюдо в виде круглой открытой лепёшки, покрытой в классическом варианте томатным соусом и расплавленным сыром.
                        ...
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Помидоры</h3>
								Томатный соус для пиццы - это основная составляющая, один из главных ингредиентов, вкус которого кардинально влияет на качество итальянского блюда. 
                    ...
                    <div class="row">
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Грибы</h3>
                                Грибная пицца – это излюбленное блюдо многих людей, которое получается особенно вкусным и аппетитным. 
                            </div>
                        </div>
                        <div class="col-md-6 responsive-column">
                            <div class="icon-box">
                                ...
                                <h3 class="bottom-line">Оливки</h3>
                               Пицца с оливками стала практически неразделима, классическая с оливками или маслинами остается наиболее популярной среди гурманов 
                            </div>
                        </div>
                    </div>
                </div><!-- .col-sm-6 -->
