...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 26 2020 г., 17:04
...
--
ALTER TABLE `otrasl`
  MODIFY `id_o` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `soiskatel`
  MODIFY `id_s` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
