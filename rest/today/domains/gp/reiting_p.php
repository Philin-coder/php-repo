...
include 'temp/header_d.php'; 
 ...
 <br>
  <div class="slider">
    ...
    <div class="row"> 
    <caption> <h2> Рейтинг востребованных профессий</h2></caption>
			<table class="table">
      <tr>
  ...
  $d1=$_POST['d1'];
  $d2=$_POST['d2'];
    $sql = "select naim_o, naim_p, SUM(case when data_razm between '$d1' and '$d2' then 1 else 0 end) As 'kol_vak',
    avg(case when data_razm between '$d1' and '$d2' then oklad end) AS 'sr_zp', 
    SUM(case when data_p between '$d1' and '$d2' and rezultat='Принят' then 1 else 0 end) As 'kol_tr'
